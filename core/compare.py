...
def compare_vectors(query_vector, index, namespace: str, top_k: int = 3) -> List[dict]:
    """
    負責根據使用者輸入的 query 向量，在指定的向量索引庫（Pinecone）中查詢最相近的資料。
